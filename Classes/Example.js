...
class Member{
	...
	tick(){
		let entities = Object.values(character.entities);
		...
		if(blacklist_players.length)
			this.pvp(blacklist_players, whitelist_players, my_chase, pty_chase, no_chase);
		else
	...
	pvp(blacklist_players, whitelist_players, my_chase, pty_chase, no_chase){
